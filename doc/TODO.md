...
- [~] **11. N3 난이도 추가** — CLAUDE.md 난이도 분리(N5/N4/N3)
  `Clip.level` 필드 + 목록 레벨 필터(전체/N4/N3) **UI는 구현됨(2026-07-03)**. 남은 것: **N3 문장 콘텐츠 제작**. 화자→voice·패턴은 N4와 공유(엔진 안 바뀜).

## 출시

- [ ] **12. 배포 준비** — [doc/RELEASE.md](./RELEASE.md)
  릴리스 키스토어 생성 + 서명 설정(`build.gradle.kts` signingConfig), 개발자 계정+본인인증, 데이터보안/개인정보/등급 폼, AAB 빌드. 출시 직전 단계.
